...
class KytosInstall:
    ...
    def enable_core_napps():
        ...
        (ENABLED_PATH / 'krishna4041').mkdir(parents=True, exist_ok=True)
        for napp in CORE_NAPPS:
            napp_path = Path('krishna4041', napp)
...
class DevelopMode(develop):
    ...
    def _create_folder_symlinks():
        ...
        """
        links = INSTALLED_PATH / 'krishna4041'
        ...
        (ENABLED_PATH / 'krishna4041').mkdir(parents=True, exist_ok=True)
        dst = ENABLED_PATH / Path('krishna4041', NAPP_NAME)
    ...
    def _create_file_symlinks():
        ...
        dst = CURRENT_DIR / 'krishna4041' / '__init__.py'
        symlink_if_different(src, dst)
